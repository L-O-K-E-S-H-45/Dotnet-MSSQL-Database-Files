...
SELECT * FROM DEPARTMENT
where DEPT_NAME like '[a-o][0-9a-d]%' -- or DEPT_NAME like '%art%'
...
INSERT INTO DEPARTMENT VALUES (10,'ACCOUNTING','NEW YORK'),(20,'RESEARCH','DALLAS'),(30,'SALES','CHICAGO'),(40,'OPEARTIONS','BOSTON')
